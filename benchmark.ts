import { smartboat } from '../dist/index';

function generateSampleGpsPoints(count: number): smartboat.telemetry.IGpsPoint[] {
  const points: smartboat.telemetry.IGpsPoint[] = [];
...
function runBenchmark() {
  ...
  const batchPayload: smartboat.telemetry.IGpsBatchRequest = {
    shipId: 1024,
    seaTripId: 5882,
    points,
